  ...
  return (
    <TemplateLayout
      ...
      hero={{
        ...
        subtitle:
          "Menu istantaneo, galleria prodotti, orari e mappa integrata per conversioni rapide e prenotazioni veloci.",
        description:
        ...
        },
        {
          ...
          content: (
            <div className="promo-banner">
              ...
              <p>
                Prenota entro venerdi con codice <strong>BRUNCH10</strong>.
              </p>
          ...
          content: (
            <div className="card-grid">
              ...
              <article className="location-card">
                ...
                <p>Valutazione: 4.8 su 320 recensioni</p>
              </article>
            </div>
          ),
        },
        {
          ...
          content: (
            <div className="map-embed">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d192387.43621120183!2d16.71726658534957!3d41.11151846636153!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x1347e8f8f3078d6f%3A0x87254066a3908e1!2sBari%2C%20Metropolitan%20City%20of%20Bari!5e0!3m2!1sen!2sit!4v1762767959444!5m2!1sen!2sit"
                title="Mappa interattiva di Bari"
                width="600"
                height="450"
                style={{ border: "0" }}
                allowFullScreen
