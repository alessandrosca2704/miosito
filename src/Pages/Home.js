        ...
        <main>
            ...
            <section className="hero two-col">
                ...
                <div className="hero-left">
                    ...
                    <h1 className="reveal">Siti Web e soluzioni IoT su misura</h1>
                    <p className="reveal delay-1">Aiuto le PMI a innovare con tecnologie moderne e scalabili.</p>

                    <div className="hero-badges">
                        <span className="pill primary">Ingegnere informatico • Web App & IoT</span>
